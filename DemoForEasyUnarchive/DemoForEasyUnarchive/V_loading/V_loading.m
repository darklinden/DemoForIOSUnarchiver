...
- (CGSize)messageSize:(NSString *)message
    ...
    CGSize oneLineSize = [message sizeWithFont:font];
                         ...
                         message:(NSString *)message
{
    ...
    pV_loading.userInteractionEnabled = NO;
    
    if (pV_loading) {
        parentView.userInteractionEnabled = NO;
        [parentView addSubview:pV_loading];
        [self constraintCustomView:pV_loading matchInView:parentView];
        ...
        [self constraintCustomView:loading centerInView:pV_loading];
...
- (void)removeLoadingView
{
    ...
    for (V_loading *pV_loading in pArr_loading) {
        if (pV_loading.superview) {
            pV_loading.superview.userInteractionEnabled = YES;
            [self removeConstraintForCustomView:pV_loading
    ...
    if (!root.userInteractionEnabled) {
