...
-(void)parse
{
	...
	[properties setObject:[XADDate XADDateWithMSDOSDateTime:archivecreataion] forKey:XADCreationDateKey];
	[properties setObject:[XADDate XADDateWithMSDOSDateTime:archivemodification] forKey:XADLastModificationDateKey];
	...
	while([self shouldKeepParsing])
	{
		...
		NSMutableDictionary *dict=[NSMutableDictionary dictionaryWithObjectsAndKeys:
			...
			[XADDate XADDateWithMSDOSDateTime:modification],XADLastModificationDateKey,
