	...
	for(int i=0;i<numentries;i++)
	{
		...
		if(flags&SIT5FLAGS_DIRECTORY)
		{
			...
			NSMutableDictionary *dict=[NSMutableDictionary dictionaryWithObjectsAndKeys:
				path,XADFileNameKey,
				[XADDate XADDateWithTimeIntervalSince1904:modificationdate],XADLastModificationDateKey,
				[XADDate XADDateWithTimeIntervalSince1904:creationdate],XADCreationDateKey,
